...
// PSRAM-resident: JPEGIMAGE state is ~30KB and internal RAM is scarce on the P4.
JPEGDEC& jpegInstance() {
  static JPEGDEC* inst = new (heap_caps_malloc(sizeof(JPEGDEC), MALLOC_CAP_SPIRAM | MALLOC_CAP_8BIT)) JPEGDEC();
  return *inst;
}
#define s_jpeg jpegInstance()
